...
from .mmseg.models.sam import ImageEncoderViTAdapt, MaskDecoder, TwoWayTransformer
...
class SAM(nn.Module):
    def __init__(self, inp_size=None, encoder_mode=None, loss=None):
        ...
        self.image_encoder = ImageEncoderViTAdapt(
            img_size=inp_size,
            ...
            act_layer=nn.GELU,
            use_abs_pos=encoder_mode['use_abs_pos'],
        ...
        self.image_embedding_size = (inp_size[0] // encoder_mode['patch_size'], inp_size[1] // encoder_mode['patch_size'])
        self.no_mask_embed = nn.Embedding(1, encoder_mode['prompt_embed_dim'])
        
        self.sparse_embeddings = torch.empty((1, 0, self.prompt_embed_dim), device=self.device)
#         print('sparse_embeddings',self.dense_embeddings.device,self.sparse_embeddings.device)
